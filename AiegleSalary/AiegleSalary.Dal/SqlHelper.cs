...
namespace AiegleSalary.Dal
{
    public class SqlHelper
    {
        ...
        #region 将SqlParameter参数数组(参数值)分配给SqlCommand命令
        /// <summary> 
        ...
        #region 将DataRow类型的列值分配到SqlParameter参数数组.
        /// <summary> 
        ...
        #region 将一个对象数组分配给SqlParameter参数数组.
        /// <summary> 
        ...
        #region 预处理用户提供的命令,数据库连接/事务/命令类型/参数
        /// <summary> 
    ...
    #region SqlHelperParameterCache提供缓存存储过程参数,并能够在运行时从存储过程中探索参数.
    /// <summary> 
